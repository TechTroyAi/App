...
internal class SpriteCatalog(private val context: Context) {
    ...
    /** Fantasy Machinery HUD, build shelf, overlays, and in-game control skins. */
    val hudTopRail = load("hud_top_rail")
    val hudBottomRail = load("hud_bottom_rail")
    val uiPanel = load("ui_panel")
    val uiPanelActive = load("ui_panel_active")
    val uiModal = load("ui_modal")
    val uiCard = load("ui_card")
    val uiCardActive = load("ui_card_active")
    val uiTab = load("ui_tab")
    val uiTabSelected = load("ui_tab_selected")
    val uiBuildSlot = load("ui_build_slot")
    val uiBuildSlotSelected = load("ui_build_slot_selected")
    val uiBuildSlotDisabled = load("ui_build_slot_disabled")
    val uiBanner = load("ui_banner")
    val uiStatFrame = load("ui_stat_frame")
    val uiButtonPrimary = load("ui_button_primary")
    val uiButtonPrimaryPressed = load("ui_button_primary_pressed")
    val uiButtonSecondary = load("ui_button_secondary")
    val uiButtonSecondaryPressed = load("ui_button_secondary_pressed")
    val uiButtonAccent = load("ui_button_accent")
    val uiButtonAccentPressed = load("ui_button_accent_pressed")
    val uiButtonWarning = load("ui_button_warning")
    val uiButtonWarningPressed = load("ui_button_warning_pressed")
    ...
    val uiIconRoute = load("ui_icon_route")
    val uiIconReforge = load("ui_icon_reforge")
    val uiIconReset = load("ui_icon_reset")
    val uiIconPause = load("ui_icon_pause")
    val uiIconFeedback = load("ui_icon_feedback")
    val uiIconBack = load("ui_icon_back")
    val uiIconUpgrade = load("ui_icon_upgrade")
    val uiIconEvolve = load("ui_icon_evolve")
    val uiIconStore = load("ui_icon_store")
    val uiIconImbue = load("ui_icon_imbue")
    val uiIconRecycle = load("ui_icon_recycle")
    val uiIconTowers = load("ui_icon_towers")
    val uiIconTraps = load("ui_icon_traps")
    val uiIconUtilities = load("ui_icon_utilities")
    val uiIconCache = load("ui_icon_cache")
    val uiIconLock = load("ui_icon_lock")
    val uiIconPrevious = load("ui_icon_previous")
    val uiIconNext = load("ui_icon_next")
    val uiIconCraft = load("ui_icon_craft")
    val uiIconSupplies = load("ui_icon_supplies")
    val uiIconSeed = load("ui_icon_seed")

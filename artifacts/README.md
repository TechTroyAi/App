...
| File | SHA-256 | Status |
|---|---|---|
| `Aureus-v1.2.0.exe` | _filled in after the CI build re-commits the signed binary_ | **current** — browser studio (record/browse/trim/delete), `-outdir`, `-trim`; icon + "Made by Troy" metadata; self-signed |

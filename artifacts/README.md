...
**`Aureus-v1.1.0.exe`** is the current Windows screen-recording utility — a
single ~2 MB portable executable, no installer and no runtime dependencies,
themed with a **black & gold minimal console UI** (gold accents, pulsing REC
dot; set `NO_COLOR=1` for plain output). v1.1.0 is the rename of the former
*ScreenRecorder*: it carries a custom **black & gold app icon**, Windows
...
- Size: ~2.2 MB · Format: PE32+ executable for MS Windows, x86-64 (machine `0x8664`)
